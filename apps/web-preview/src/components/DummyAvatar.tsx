  ...
  return (
    <group position={motion.rootPosition}>
      ...
      <group rotation={motion.headRotation}>
        ...
        <mesh position={[-0.27, 0.35, 0.68]} scale={[0.14, leftEyeHeight, 0.04]}>
          <sphereGeometry args={[1, 16, 16]} />
          <meshBasicMaterial />
        </mesh>
        <mesh position={[0.27, 0.35, 0.68]} scale={[0.14, rightEyeHeight, 0.04]}>
          <sphereGeometry args={[1, 16, 16]} />
          <meshBasicMaterial />
        </mesh>
        <mesh position={[-0.27 + gazeX, 0.35 + gazeY, 0.73]} scale={[0.045, 0.045, 0.02]}>
        ...
        <mesh position={[0, -0.12, 0.72]} scale={[mouthWidth, mouthHeight, 0.04]}>
          <boxGeometry />
          <meshNormalMaterial />
        </mesh>
      </group>
