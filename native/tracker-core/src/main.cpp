    ...
    if (argument == "--helper-runtime-smoke-case") {
      ...
      if (smokeCase == "normal") {
        ...
        std::cerr << "Unsupported --helper-runtime-smoke-case: " << smokeCase
                  ...
                  << "helper-lifecycle-handshake-malformed-ready, and "
